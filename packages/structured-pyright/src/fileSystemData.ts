...
export const typeshedDirEntries: DirListing = {
    ...
    'stubs/pandas/pandas': [
        { name: '_version.pyi', isFile: true, isDir: false },
        { name: 'core', isFile: false, isDir: true },
        { name: 'util', isFile: false, isDir: true },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'io', isFile: false, isDir: true },
        { name: 'tseries', isFile: false, isDir: true },
        { name: '_testing', isFile: false, isDir: true },
        { name: '_libs', isFile: false, isDir: true },
        { name: '_typing.pyi', isFile: true, isDir: false },
        { name: 'plotting', isFile: false, isDir: true },
        { name: 'testing.pyi', isFile: true, isDir: false },
        { name: 'arrays', isFile: false, isDir: true },
        { name: 'py.typed', isFile: true, isDir: false },
        { name: 'api', isFile: false, isDir: true },
        { name: 'errors', isFile: false, isDir: true },
        { name: '_config', isFile: false, isDir: true },
    ],
    'stubs/pandas/pandas/core': [
        { name: 'reshape', isFile: false, isDir: true },
        { name: 'generic.pyi', isFile: true, isDir: false },
        { name: 'base.pyi', isFile: true, isDir: false },
        { name: 'tools', isFile: false, isDir: true },
        { name: 'resample.pyi', isFile: true, isDir: false },
        { name: 'strings.pyi', isFile: true, isDir: false },
        { name: 'indexing.pyi', isFile: true, isDir: false },
        { name: 'util', isFile: false, isDir: true },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'missing.pyi', isFile: true, isDir: false },
        { name: 'interchange', isFile: false, isDir: true },
        { name: 'construction.pyi', isFile: true, isDir: false },
        { name: 'algorithms.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'common.pyi', isFile: true, isDir: false },
        { name: 'frame.pyi', isFile: true, isDir: false },
        { name: 'dtypes', isFile: false, isDir: true },
        { name: 'indexers.pyi', isFile: true, isDir: false },
        { name: 'groupby', isFile: false, isDir: true },
        { name: 'computation', isFile: false, isDir: true },
        { name: 'arraylike.pyi', isFile: true, isDir: false },
        { name: 'window', isFile: false, isDir: true },
        { name: 'arrays', isFile: false, isDir: true },
        { name: 'series.pyi', isFile: true, isDir: false },
        { name: 'ops', isFile: false, isDir: true },
        { name: 'sparse', isFile: false, isDir: true },
        { name: 'accessor.pyi', isFile: true, isDir: false },
        { name: 'config_init.pyi', isFile: true, isDir: false },
        { name: 'indexes', isFile: false, isDir: true },
    ],
    'stubs/pandas/pandas/core/reshape': [
        { name: 'concat.pyi', isFile: true, isDir: false },
        { name: 'merge.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'util.pyi', isFile: true, isDir: false },
        { name: 'pivot.pyi', isFile: true, isDir: false },
        { name: 'tile.pyi', isFile: true, isDir: false },
        { name: 'encoding.pyi', isFile: true, isDir: false },
        { name: 'melt.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/tools': [
        { name: 'numeric.pyi', isFile: true, isDir: false },
        { name: 'timedeltas.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'datetimes.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/util': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'hashing.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/interchange': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'from_dataframe.pyi', isFile: true, isDir: false },
        { name: 'dataframe_protocol.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/dtypes': [
        { name: 'generic.pyi', isFile: true, isDir: false },
        { name: 'base.pyi', isFile: true, isDir: false },
        { name: 'concat.pyi', isFile: true, isDir: false },
        { name: 'dtypes.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'missing.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'common.pyi', isFile: true, isDir: false },
        { name: 'inference.pyi', isFile: true, isDir: false },
        { name: 'cast.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/groupby': [
        { name: 'generic.pyi', isFile: true, isDir: false },
        { name: 'base.pyi', isFile: true, isDir: false },
        { name: 'categorical.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'groupby.pyi', isFile: true, isDir: false },
        { name: 'ops.pyi', isFile: true, isDir: false },
        { name: 'grouper.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/computation': [
        { name: 'parsing.pyi', isFile: true, isDir: false },
        { name: 'expressions.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'expr.pyi', isFile: true, isDir: false },
        { name: 'ops.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'common.pyi', isFile: true, isDir: false },
        { name: 'eval.pyi', isFile: true, isDir: false },
        { name: 'engines.pyi', isFile: true, isDir: false },
        { name: 'pytables.pyi', isFile: true, isDir: false },
        { name: 'scope.pyi', isFile: true, isDir: false },
        { name: 'align.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/window': [
        { name: 'ewm.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'expanding.pyi', isFile: true, isDir: false },
        { name: 'rolling.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/arrays': [
        { name: 'numeric.pyi', isFile: true, isDir: false },
        { name: 'base.pyi', isFile: true, isDir: false },
        { name: 'numpy_.pyi', isFile: true, isDir: false },
        { name: 'floating.pyi', isFile: true, isDir: false },
        { name: 'timedeltas.pyi', isFile: true, isDir: false },
        { name: 'categorical.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'arrow', isFile: false, isDir: true },
        { name: 'period.pyi', isFile: true, isDir: false },
        { name: 'string_.pyi', isFile: true, isDir: false },
        { name: 'interval.pyi', isFile: true, isDir: false },
        { name: 'datetimelike.pyi', isFile: true, isDir: false },
        { name: 'datetimes.pyi', isFile: true, isDir: false },
        { name: 'integer.pyi', isFile: true, isDir: false },
        { name: 'boolean.pyi', isFile: true, isDir: false },
        { name: 'sparse', isFile: false, isDir: true },
        { name: 'masked.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/arrays/arrow': [{ name: 'dtype.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/core/arrays/sparse': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'dtype.pyi', isFile: true, isDir: false },
        { name: 'accessor.pyi', isFile: true, isDir: false },
        { name: 'array.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/ops': [
        { name: 'invalid.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'common.pyi', isFile: true, isDir: false },
        { name: 'dispatch.pyi', isFile: true, isDir: false },
        { name: 'docstrings.pyi', isFile: true, isDir: false },
        { name: 'mask_ops.pyi', isFile: true, isDir: false },
        { name: 'array_ops.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/core/sparse': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/core/indexes': [
        { name: 'accessors.pyi', isFile: true, isDir: false },
        { name: 'frozen.pyi', isFile: true, isDir: false },
        { name: 'numeric.pyi', isFile: true, isDir: false },
        { name: 'base.pyi', isFile: true, isDir: false },
        { name: 'timedeltas.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'period.pyi', isFile: true, isDir: false },
        { name: 'extension.pyi', isFile: true, isDir: false },
        { name: 'range.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'interval.pyi', isFile: true, isDir: false },
        { name: 'datetimelike.pyi', isFile: true, isDir: false },
        { name: 'datetimes.pyi', isFile: true, isDir: false },
        { name: 'multi.pyi', isFile: true, isDir: false },
        { name: 'category.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/util': [
        { name: '_validators.pyi', isFile: true, isDir: false },
        { name: '_decorators.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: '_tester.pyi', isFile: true, isDir: false },
        { name: '_print_versions.pyi', isFile: true, isDir: false },
        { name: '_exceptions.pyi', isFile: true, isDir: false },
        { name: 'version', isFile: false, isDir: true },
        { name: '_doctools.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/util/version': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/io': [
        { name: 'stata.pyi', isFile: true, isDir: false },
        { name: 'html.pyi', isFile: true, isDir: false },
        { name: 'parsers', isFile: false, isDir: true },
        { name: 'parquet.pyi', isFile: true, isDir: false },
        { name: 'formats', isFile: false, isDir: true },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'clipboards.pyi', isFile: true, isDir: false },
        { name: 'spss.pyi', isFile: true, isDir: false },
        { name: 'excel', isFile: false, isDir: true },
        { name: 'feather_format.pyi', isFile: true, isDir: false },
        { name: 'parsers.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'common.pyi', isFile: true, isDir: false },
        { name: 'orc.pyi', isFile: true, isDir: false },
        { name: 'json', isFile: false, isDir: true },
        { name: 'sas', isFile: false, isDir: true },
        { name: 'pickle.pyi', isFile: true, isDir: false },
        { name: 'pytables.pyi', isFile: true, isDir: false },
        { name: 'gbq.pyi', isFile: true, isDir: false },
        { name: 'xml.pyi', isFile: true, isDir: false },
        { name: 'sql.pyi', isFile: true, isDir: false },
        { name: 'clipboard', isFile: false, isDir: true },
    ],
    'stubs/pandas/pandas/io/parsers': [
        { name: 'readers.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/io/formats': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'format.pyi', isFile: true, isDir: false },
        { name: 'style.pyi', isFile: true, isDir: false },
        { name: 'css.pyi', isFile: true, isDir: false },
        { name: 'style_render.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/io/excel': [
        { name: '_util.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: '_base.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/io/json': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: '_table_schema.pyi', isFile: true, isDir: false },
        { name: '_normalize.pyi', isFile: true, isDir: false },
        { name: '_json.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/io/sas': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'sas_xport.pyi', isFile: true, isDir: false },
        { name: 'sas7bdat.pyi', isFile: true, isDir: false },
        { name: 'sasreader.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/io/clipboard': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/tseries': [
        { name: 'offsets.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'holiday.pyi', isFile: true, isDir: false },
        { name: 'api.pyi', isFile: true, isDir: false },
        { name: 'frequencies.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/_testing': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/_libs': [
        { name: 'lib.pyi', isFile: true, isDir: false },
        { name: 'indexing.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'ops_dispatch.pyi', isFile: true, isDir: false },
        { name: 'missing.pyi', isFile: true, isDir: false },
        { name: 'interval.pyi', isFile: true, isDir: false },
        { name: 'json.pyi', isFile: true, isDir: false },
        { name: 'sparse.pyi', isFile: true, isDir: false },
        { name: 'window', isFile: false, isDir: true },
        { name: 'tslibs', isFile: false, isDir: true },
        { name: 'properties.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/_libs/window': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/_libs/tslibs': [
        { name: 'offsets.pyi', isFile: true, isDir: false },
        { name: 'tzconversion.pyi', isFile: true, isDir: false },
        { name: 'base.pyi', isFile: true, isDir: false },
        { name: 'timedeltas.pyi', isFile: true, isDir: false },
        { name: 'parsing.pyi', isFile: true, isDir: false },
        { name: 'dtypes.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'np_datetime.pyi', isFile: true, isDir: false },
        { name: 'vectorized.pyi', isFile: true, isDir: false },
        { name: 'strptime.pyi', isFile: true, isDir: false },
        { name: 'period.pyi', isFile: true, isDir: false },
        { name: 'timestamps.pyi', isFile: true, isDir: false },
        { name: 'nattype.pyi', isFile: true, isDir: false },
        { name: 'conversion.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/plotting': [
        { name: '_misc.pyi', isFile: true, isDir: false },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: '_core.pyi', isFile: true, isDir: false },
    ],
    'stubs/pandas/pandas/arrays': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/api': [
        { name: 'indexers', isFile: false, isDir: true },
        { name: 'types', isFile: false, isDir: true },
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'interchange', isFile: false, isDir: true },
        { name: 'extensions', isFile: false, isDir: true },
    ],
    'stubs/pandas/pandas/api/indexers': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/api/types': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/api/interchange': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/api/extensions': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/errors': [{ name: '__init__.pyi', isFile: true, isDir: false }],
    'stubs/pandas/pandas/_config': [
        { name: '__init__.pyi', isFile: true, isDir: false },
        { name: 'config.pyi', isFile: true, isDir: false },
    ],
};
